...
namespace Visionist.Portal
{
    public class EmailHelper
    {
        public const string SenderEmailAddress = "sahar@visionistsolutions.net";
        public const string SenderPassword = "C00@Visionist";
        public const string SenderHost = "smtp.gmail.com";
        public const int SenderPort = 587;
        public const string RecipientEmailAddress = "sahar@visionistsolutions.net";
